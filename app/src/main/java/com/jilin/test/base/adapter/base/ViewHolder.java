...
package com.jilin.test.base.adapter.base;
...
public class ViewHolder {
    ...
    public ViewHolder setSelected(int viewId, boolean enable) {
        View view = getView(viewId);
        view.setSelected(enable);
        return this;
    }

    public ViewHolder setGridAdapter(int viewId, CommonAdapter commonAdapter) {
        GridView view = getView(viewId);
        view.setAdapter(commonAdapter);
        return this;
    }

    public ViewHolder setListAdapter(int viewId, CommonAdapter commonAdapter) {
        ListView view = getView(viewId);
        view.setAdapter(commonAdapter);
        return this;
    }

    public ViewHolder addListHeaderView(int viewId) {
        ListView view = getView(viewId);
        view.addHeaderView(new ViewStub(mContext));
        return this;
    }
